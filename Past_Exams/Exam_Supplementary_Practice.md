...
1. Try solving **Exam 1** without looking at the highlighted solutions. Pay close attention to **Part 4 (Code Tracing)** and **Part 5 Section B (Bakery Algorithm proof)**, as these are identical to what you will face in the exam room.
2. For any math sections, write out the formulas explicitly before plugging in values, as the BIU grading rubric awards substantial partial credit for correct workflows even if a calculation typo occurs.
